...
одновременно решать классификацию (есть/нет собаки) и локализацию (координаты объекта на изображении);
2строить временные и пространственные распределения по результатам детекции (например, подсчёт собак по районам и по дням).
